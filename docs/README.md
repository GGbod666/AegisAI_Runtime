...
| `task_list.md` | Active work plan | Detailed prioritized tasks, dependencies, and acceptance checks derived from the current README/status. |
| `next_stage.md` | Stage strategy | Evidence-hardening objective, stage gates, and command sequence. Keep task detail in `task_list.md`. |
...
| `modular_execution_plan.md` | Historical implementation plan | Early staged execution plan. Treat as reference; current work lives in `next_stage.md` and `task_list.md`. |
...
- Keep detailed task breakdown in `task_list.md`.
